init python:
    ...
    try:
        ...
        requests = None # not available in web build
    ...
    for chara in charas:
        renpy.image(chara + '_eyes_blink', DynamicBlink(
            "images/chara/{}/{}_eyes_open.png".format(chara, chara),
            "images/chara/{}/{}_eyes_closed.png".format(chara, chara)
            )
        )
...
init:
    ...
    define mint = Character(_("薄荷"), callback=meow_sound_callback) # player's cat
