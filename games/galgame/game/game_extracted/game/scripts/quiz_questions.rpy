...
init 101 python:
    ...
    trivia_questions = [
    QuizQuestion(
        question=_("训练神经网络哪个更快，GPU还是CPU？"),
        true=_("GPU."),
        false=[_("CPU."), _("They are the same.")]
        ),
    QuizQuestion(
        question=_("汇编语言中哪个是合法标识符？"),
        true=_("july_2021"),
    ...
    QuizQuestion(
        question=_("哪个精度更高，double还是float？"),
        true=_("A double."),
        false=[_("A float."), _("They have the same precision.")]
        ),
    QuizQuestion(
        question=_("以下哪种编程语言由日本开发者创建？"),
        true=_("Ruby"),
        false=[_("C"), _("C++"), _("Java"), _("Kotlin"), _("Python")]
        ),
    QuizQuestion(
        question=_("C++中哪个运算符优先级最高？"),
        true=_("!"),
        false=[_("*"), _("&&"), _("!=")]
        ),
    QuizQuestion(
        question=_("Python编程语言名字的含义是什么？"),
        true=_("Monty Python"),
        false=[_("The snake")]
        ),
    QuizQuestion(
        question=_("Java最初的名字是什么？"),
        true=_("Oak"),
        false=[_("咖啡"), _("JavaScript"), _("Guava"), _("Homebrew")]
        ),
    ...
    QuizQuestion(
    question=_("freeCodeCamp是501(c)(3)公共慈善机构（非营利），其使命是："),
